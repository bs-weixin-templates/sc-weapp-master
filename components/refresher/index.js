...
Component({
    ...
    data: {
        className: 'sc-refresher-hidden',
        style: defaultStyle,
    },
    properties: {
        pullingIcon: {
            type: String,
            value: 'sc-refresher-icon-arrow-down',
        },
        pullingText: {
            type: String,
            value: '下拉刷新',
        ...
        refreshingIcon: {
            type: String,
            value: 'sc-refresher-icon-refresher',
        },
        refreshingText: {
            type: String,
            value: '正在刷新',
    ...
    methods: {
        ...
        activate() {
            this.setData({
                style: defaultStyle,
                className: 'sc-refresher-visible',
            })
        },
        /**
         * 隐藏
        ...
        refreshing() {
            this.setData({
                ...
                className: 'sc-refresher-active sc-refresher-refreshing',
            })
        },
        /**
         * 刷新后隐藏动画
        ...
        tail() {
            this.setData({
                className: 'sc-refresher-active sc-refresher-refreshing sc-refresher-refreshing-tail',
            })
        },
        /**
         * 正在下拉
        ...
        move(diffY) {
            ...
            const className = diffY < this.data.distance ? 'sc-refresher-visible' : 'sc-refresher-active'
         ...
         */
        isRefreshing() {
            return this.data.className.indexOf('sc-refresher-refreshing') !== -1
        },
        /**
         * 获取触摸点坐标
         */
